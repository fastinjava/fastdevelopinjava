...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/fastdevelopinjava-service-system-manage/src/main/java/");
        gc.setAuthor("lify");
        gc.setOpen(false);
...
//
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/fastdevelopinjava_user?useSSL=false&useUnicode=true&characterEncoding=UTF8&serverTimezone=GMT");
...
//        mpg.setDataSource(dsc);
        ...
        pc.setParent("com.fastdevelopinjava.service");
        mpg.setPackageInfo(pc);
//        // 包配置
//        PackageConfig pc = new PackageConfig();
//        pc.setModuleName("spring_boot_mybatis_plus");
//        pc.setParent("com.fastdevelopinjava.service.user");
//        mpg.setPackageInfo(pc);

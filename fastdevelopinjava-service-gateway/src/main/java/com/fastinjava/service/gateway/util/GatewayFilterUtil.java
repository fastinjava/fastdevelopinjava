package com.fastinjava.service.gateway.util;

import com.fastinjava.service.gateway.config.CachedBodyOutputMessage;
...
public class GatewayFilterUtil {
    ...
    public static String getRequestBody(ServerWebExchange exchange) {
        Object requestBody = exchange.getAttributes().get("REQUEST_BODY");
        if (null != requestBody) {
